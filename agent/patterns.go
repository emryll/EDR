...
//* This file just contains the definition of patterns, the full implementation
//* is spread across several files: behavioral.go events.go, timeline.go, conditions.go,
//* filter.go, yaml.go, handles.go, groups.go, and pools.go.
